...
class Signup:
    def __init__(self,page:Page):
        self.page =                                           page
        self.mr_checkBox =                                    self.page.locator("#id_gender1")
        self.mrs_checkBox =                                   self.page.locator("id_gender2")
        ...
        self.firstname =                                      self.page.get_by_label("first_name")
        self.lastname =                                       self.page.get_by_label("last_name")
        self.company =                                        self.page.get_by_label("company")
